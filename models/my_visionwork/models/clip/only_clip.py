...
def prediction(video_id, frames):
    ...
    "Crowd",
    "Several individuals",
    "Multiple humans visible",
    "Group of individuals",
    "Many people present",
    "More than one person in the frame",
    "Several people together",
    "Crowded scene",
    "Multiple figures in the image",
    "A gathering of people",
    "Group scene",
    "Many humans in the image",
    "Several individuals present",
    "Multiple people captured",
    "A crowd of humans",
    "Several human figures in the scene",
    "A number of people present",
    "More than one person visible",
    "Several individuals together",
    "A crowd in the background",
    "Many people in the shot",
    "A group of humans present",
    "Multiple persons in focus",
    "A group of several people",
    "People gathering in the image",
    "More than one human figure",
    "Group of friends or individuals",
    "Several people are pictured",
    "A number of human figures",
    "Crowded image with people",
    "Human figures in a group",
    "Many human figures captured",
    "Scene with a crowd",
    "Multiple individuals in the image",
    "Crowded shot with people",
    "Several people in focus",
    "More than one individual present",
    "A group of people in the frame",
    "Several humans present",
    "Group gathering visible",
    "A bunch of people in the image",
    "A mix of people in the scene",
    "Several individuals in the shot",
    "Group of individuals captured",
    "A large number of people",
    "Scene showing a group",
    "Multiple people in focus",
    "Many individuals visible",
        # "This image shows multiple people or humans present.",
        # "There are several individuals in this scene.",
        # "The scene includes more than one person.",
    ...
    "single_person": [
        ...
        "One person present",
        "Lone figure in the scene",
        "Only one person in the frame",
        "One human subject",
        "Solo individual in the image",
        "Person by themselves",
        "Single human presence",
        "Just one person in the shot",
        "A lone human figure",
        "Single person captured",
        "One figure in the image",
        "Solitary individual present",
        "One person alone",
        "Only one person visible",
        "Solo person present",
        "Single human visible",
        "One figure in the frame",
        "One human being",
        "One individual in the scene",
        "Single human in the picture",
        "Just one human present",
        "Lone individual in focus",
        "A person by themselves",
        "Individual person",
        "One person pictured",
        "Single human in view",
        "One subject in the image",
        "A single subject in the scene",
        "Just one human subject",
        "One person depicted",
        "Single human subject",
        "Solitary individual in the frame",
        "A person standing alone",
        "One human presence",
        "Only one figure visible",
        "A lone figure visible",
        "Just one human in the picture",
        "One person standing",
        "One individual captured",
        "One person in the shot",
        "Single person in the background",
        "Solo human presence in the frame",

        # "A photo of a single person",
        # "A photo of a single individual",
        # # "A photo of solitary figure",
        # "A photo of a lone person",

        # "This image features exactly one person present.",
        # "There is a single human figure in this scene.",
        # "The scene depicts one individual only.",
    ...
    "no_person": [
        ...
        "Vacant setting",
        "Image without any people",
        "Uninhabited scene",
        "Deserted environment",
        "Absent of any human figures",
        "Scene without any people",
        "Landscape with no humans",
        "No person visible in the image",
        "No signs of people present",
        "Human-free environment",
        "Unpopulated scene",
        "Picture without any human activity",
        "No one in this space",
        "Open area with no people",
        "Image with zero humans",
        "No humans captured",
        "Empty background",
        "Unoccupied scene",
        "No living beings visible",
        "No figures in the image",
        "Still setting with no people",
        "Void of human presence",
        "Vacant space",
        "Empty room or setting",
        "Barren landscape",
        "Scene with no human traces",
        "Isolated landscape without people",
        "Clear of any human figures",
        "Empty street or area",
        "Image devoid of people",
        "No person in sight",
        "Humanless environment",
        "No one in the background",
        "No visible individuals",
        "Clear of any human subjects",
        "Scene without life",
        "Lifeless area",
        "Barren space",
        "No signs of life",
        "Deserted backdrop",
        "Empty corridor or room",
        "Void of any living beings",
        "Picture without anyone",
        "Uninhabited area",
        "No visible human activity",


        # "A photo of no people present",
        # "A photo of no humans present",


        # "This image contains no people or humans present.",
        # "There are no individuals or human figures in this scene.",
        # "The scene depicted does not include any persons.",


        # "A photo with no person",
        # "a photo without a person.",
        ...
        if len(frame_window) == window_size:
            ...
            if curr_label != prev_label and curr_label != next_label:
                ...
                if prev_label == next_label:
                    ...
                    curr_frame["final_label"] = majority_label
                    curr_frame["final_prob"] = max_prob 
